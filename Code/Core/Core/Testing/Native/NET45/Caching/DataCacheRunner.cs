...
namespace LightHouse.Core.Caching.Testing
{
    public class DataCacheRunner
    {
        ...
        {
            TestConfiguration.DataCache.RemoveObjectFromSpecificRegion();
        }
        ...
        {
            TestConfiguration.DataCache.RemoveObjectFromDefaultRegion();
        }
        ...
        {
            TestConfiguration.DataCache.CreateRegionIfDoesNotExist();
        }
        ...
        {
            TestConfiguration.DataCache.CheckRegion();
        }
    }
}

...
namespace LightHouse.Core.Testing
{
    public static class TestConfiguration
    {
        ...
        private static LightHouse.Core.Testing.Common common;
        public static LightHouse.Core.Testing.Common Common
        {
            get
            {
                if (common == null)
                {
                    common = new LightHouse.Core.Testing.Common();
                }
        ...
        private static LightHouse.Core.Attributes.Testing.Path path;
        public static LightHouse.Core.Attributes.Testing.Path Path
        {
            get
            {
                if (path == null)
                {
                    path = new LightHouse.Core.Attributes.Testing.Path();
                }
        ...
        private static LightHouse.Core.Caching.Testing.DataRegion dataRegion;
        public static LightHouse.Core.Caching.Testing.DataRegion DataRegion
        {
            get
            {
                if (dataRegion == null)
                {
                    dataRegion = new LightHouse.Core.Caching.Testing.DataRegion();
                }
        ...
        private static LightHouse.Core.Elite.Converting.Testing.Converter converter;
        public static LightHouse.Core.Elite.Converting.Testing.Converter Converter
        {
            get
            {
                if (converter == null)
                {
                    converter = new LightHouse.Core.Elite.Converting.Testing.Converter();
                }
        ...
        private static LightHouse.Core.Collections.Testing.DataList dataList;
        public static LightHouse.Core.Collections.Testing.DataList DataList
        {
            get
            {
                if (dataList == null)
                {
                    dataList = new LightHouse.Core.Collections.Testing.DataList();
                }
        ...
        private static LightHouse.Core.Collections.Testing.ContractList contractList;
        public static LightHouse.Core.Collections.Testing.ContractList ContractList
        {
            get
            {
                if (contractList == null)
                {
                    contractList = new LightHouse.Core.Collections.Testing.ContractList();
                }
